...
After finishing assemblies and uploading relevant outputs, update the metadata file using instructions [here](https://github.com/gradlab/lab-handbook/wiki/Computational-Manual#updating-the-metadata-table) and [here](https://github.com/gradlab/gc_genomics/tree/master/metadata). Commit and push the changes, and in the commit message close the relevant issue. 
